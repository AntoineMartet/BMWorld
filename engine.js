...
for(let i = (creatureTotal.length);i < 100; i++) {
    creatureTotal.push({
        ...
        "profile"  : [Math.round((Math.random() * 1.01),2),   Math.round((Math.random() * 1.01),2),
            Math.round((Math.random() * 1.01),2),  Math.round((Math.random() * 1.01),2),   Math.round((Math.random() * 1.01),2)],
